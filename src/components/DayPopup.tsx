...
function DayPopup({ open = null, setOpen, date, handleClick, events }: { open: Boolean | null, setOpen: Function, date: Date, handleClick: (event: MPEvent) => void, events: MPEvent[] }) {
