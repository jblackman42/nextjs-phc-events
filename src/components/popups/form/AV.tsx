...
const AVPopup = () => {
  ...
  return <DialogContent>
    <DialogHeader>
      ...
      <DialogTitle className="pb-1">Set Up A/V</DialogTitle>
      <DialogDescription className="hidden">Fill out the form below to set up a A/V for your event.</DialogDescription>
    </DialogHeader>
