...
const PromotionPopup = () => {
  ...
  return <DialogContent>
    <DialogHeader>
      ...
      <DialogTitle className="pb-1">Set Up Promotion</DialogTitle>
      <DialogDescription className="hidden">Fill out the form below to set up promotion for your event.</DialogDescription>
    </DialogHeader>
